...
UploadsSqlAlchemyBase = orm.declarative_base()

__factory = None


def uploads_global_init(db_file):
    global __factory
    ...
    UploadsSqlAlchemyBase.metadata.create_all(uploads_engine)


def uploads_create_session() -> Session:
    global __factory
